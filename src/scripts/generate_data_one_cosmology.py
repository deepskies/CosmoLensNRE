...
def main():
    ...
    parser.add_argument('--Om0', type=float, required=True, help='Omega matter (Om0)')
    parser.add_argument('--w0', type=float, required=True, help='Equation of state parameter (w0)')
